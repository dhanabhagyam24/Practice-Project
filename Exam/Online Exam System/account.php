...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Take Exam</b></a>
    </div>
...
<a href="#" data-toggle="modal" data-target="#developers">Instruction</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' ">Exam Instruction<span style="color:orange"></span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/exam.jpg" width=100 height=100 alt="DhanaBhagyam S" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Examination">*The examination does not require using any paper, pen, pencil and calculator.</a>
		
		<h4 style="font-family:'typo' ">*Every student will take the examination on a Laptop/Desktop.</h4>
		<h4 style="font-family:'typo' ">*On computer screen every student will be given objective type type Multiple Choice
Questions (MCQs)</h4></div></div>
		</p>
      </div>
